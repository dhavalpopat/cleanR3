...
<ul class="sub-menu">
<li><a href="#why-reduce"><span>Why reduce?</span></a></li>
<li><a href="#buy-better"><span>Buying better commodities</span></a></li>
<li><a href="#think-before-buying"><span>Think before buying</span></a></li>
<li><a href="#more-to-reduce"><span>What more to do for reducing?</span></a></li>
</ul>
</li>
<li>
<a href="reuse.php">
...
From thinking differently about what you buy, to using re-usable items, to and 
composting at home - there are lots of ways to make a real difference.
</h3>
<img class="image" src="img/reduce.png" />
<br>
<br>
<div id="why-reduce">
<h2><b>Why reduce?</b></h2>
<h3 align="justify">
Of the 'three R's' of 'recycling' (reduce, reuse, recycle), 'reduce waste' is the most important. 
This is because everything that we throw away, first of all had to be made. 
This is significant because making anything, particularly here in the west, inherently involves the creation of a lot of waste. 
By reducing waste we can significantly reduce our environmental foot print.
</h3>
</div>

<div id="buy-better">
<h2><b>Buying better commodities</b></h2>
<h3 align="justify">
Some products are designed to reduce their overall environmental impact. These products are usually 
more than just energy efficient - they're designed to last longer, or be cleaned, repaired, upgraded or recycled more easily.
Our research shows that householders like many products to last a long time, but that over a quarter of washing machines, 
fridges and vacuum cleaners don't last as long as owners expect them to. 
If you're investing your hard-earned cash on a new appliance for your home, try to work out how long you want it to last - 
and whether you will get value for money from it. Manufacturer guarantees can help you work out how long the product can last - 
so when you're shopping around, see how long the manufacturer's free guarantee is. <br>
Better products are made to last longer. <br>
They can be repaired easily, either without tools or with simple common tools. <br>
They use recycled materials like plastics and metal. <br>
They reduce the energy they use. <br>
They adjust the energy they use to suit different tasks. <br>
They contain fewer harmful chemicals.
</h3>
</div>

<div id="think-before-buying">
<h2><b>Think before buying</b></h2>
<h3 align="justify">
You can reduce waste by giving family or friends a gift experience instead of a product. 
For example, a gift certificate might be just the thing for someone who would like to begin a new hobby or try something new.
Use rechargeable batteries and a battery charger. This saves energy because the energy needed to manufacture a battery is on 
average 50 times greater than the energy it gives out. While the rechargeable cells have a higher initial cost, rechargeable batteries can be recharged many times.
Using rechargeable battery system can reduce toxic materials sent to landfills compared to using disposable batteries. 
For example, some rechargeable batteries claim a service life of 100-1000 times more than a regular battery. 
...
<div id="more-to-reduce">
<h2><b>What more to do for reducing?</b></h2>
<h3 align="justify">
...
Around a staggering £12.5 billion worth of food is thrown away in Britain annually, if we stopped wasting good food we could avoid around 17 million tonnes 
of carbon dioxide equivalents being emitted each year, the same as taking 1 in 4 cars off of UK roads. 
The Energy Saving Trust can help you to make some simple energy saving home improvements, save money on your energy bills, 
improve the comfort of your home and help fight climate change.
...
Green Thing is an online community for anyone who wants to be a bit greener and needs some advice on how to do this. 
It focuses on seven things you can do – and enjoy doing – to live a greener lifestyle.
</h3>
</div>

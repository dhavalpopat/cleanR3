...
<title>Clean R3 | What to do with</title>
...
<ul class="sub-menu">
<li><a href="#electrical"><span>Electrical</span></a></li>
<li><a href="#medicines"><span>Medicines</span></a></li>
<li><a href="#plastic"><span>Plastic</span></a></li>
<li><a href="#clothing"><span>Clothing</span></a></li>
<li><a href="#furniture"><span>Furniture</span></a></li>
</ul>
</li>
<li>
<a href="reduce.php">
...
<img class="image" src="img/electrical.png" />
<h3 align="justify">
Small electrical items can be recycled or passed on to others if they are in good working condition.
There are lots of things that fall into this category and includes items such as alarm clocks; 
CD/DVD/Cassette players and game consoles; small kitchen appliances such as kettles, toasters, 
food mixers and blenders, microwave ovens; personal grooming products like hairdryers, straighteners, 
curling tongs, electric toothbrushes and shavers; garden tools such as lawnmowers, hedge trimmers and 
leaf blowers/shredders; other items such as lamps, torches, vacuum cleaners, telephones, mobiles, 
radios, TV's, printers, camcorders, cameras and smoke alarms.
</h3>
</div>

<div id="medicines">
<h1>MEDICINES</h1>
<img class="image" src="img/medicines.png" />
<h3 align="justify">
Unopened, unused and out-of-date medicines can be returned to pharmacies for disposal. 
Once medicines have left the pharmacy, they cannot be recycled or re-used by anyone else. 
Inhalers are recyclable though at participating pharmacies.
...
A campaign called Only Order What You Need, working with the NHS, asks people to think carefully before ordering repeat prescriptons.
</h3>
</div>

<div id="plastic">
<h1>PLASTIC WASTE</h1>
<img class="image" src="img/plastic.png" />
<h3 align="justify">
Plastic waste is not usually accepted as part of your household recycling scheme or at your local recycling centre. 
However, some types of plastic waste can be recycled in the carrier bag collection points at the larger stores of most major supermarkets.
</h3>
</div>

<div id="clothing">
<h1>OLD CLOTHES</h1>
<img class="image" src="img/clothing.png" />
<h3 align="justify">
We all have clothes in our wardrobes or curtains, pillow cases, duvet covers, blankets, sheets and 
towels in our cupboards that we don’t need or want any more. Sometimes we have items that are past their best too.
...
If you are fundraising for your school, church, workplace, sports club or organisations such as Girl Guides, 
or Scouts, there are textile companies who can arrange a textile collection to help you to raise money for your cause. 
...
There has never been a better time to sell unwanted clothes and there are lots of ways to do this. 
With two thirds of people already buying pre-owned and vintage clothes, its an ideal time to try selling yours! 
</h3>
</div>

<div id="furniture">
<h1>OLD FURNITURE</h1>
<img class="image" src="img/furniture.png" />
<h3 align="justify">
...
Upholstered furniture such as sofas and mattresses need to have their fire safety label intact - 
otherwise charities and re-use organisations are unable to sell them on. 
Pass on items for free at places such as Freecycle and Freegle
Or sell them on websites like eBay, Gumtree and Preloved. 
If you have items which are broken and need a lick of paint or a simple repair to get them back into shape, why not have a go? 
With a bit of practice and TLC your old furniture could take on a whole new lease of life! If you are unsure, ask family or friends for help.

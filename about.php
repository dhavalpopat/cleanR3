...
<img id="image" src="img/about.png" />

<br>
<br>

<h3 align="justify">
CleanR3.com is a website which focuses on recycling, reducing, reusing commodities and maintaining cleanliness 
which can be all achieved by people without much difficulty by using the website. 
We make people aware about the importance of recycling, reducing and reusing in today’s world. 
Most of the people have less idea about how to recycle or what to do with their commodities such as plastics, electrical materials, old clothes, etc. 
We provide assistance to people by providing them various tips related to the 3 R’s and 
also help them in finding out the recycling centers which are in their vicinity. 
This will encourage people to recycle the commodities. As the user logs in to our website, 
we also allow them to upload the images of the trash littered on the streets and forward this information to the local authorities. 
The users will get updated on their request as the progress is made. 
We have made the website responsive so that users can access the website on any of their devices. 
We have also made efforts to keep the website user friendly and simple to use.
</h3>

...
<div class="form_info cmsms_input">
	<label for="contact_email_1">Your Email<span class="color_2"> *</span></label>
	<div class="form_field_wrap">
	<input type="text" name="contact_email" id="contact_email" size="35" tabindex="12" class="validate[required,custom[email]]" required />
	</div>
	</div>
<br><br>
<div class="form_info cmsms_input">
	<label for="contact_email_1">Your Password<span class="color_2"> *</span></label>
	<div class="form_field_wrap">
	<input type="password" name="pass" id="pass" size="35" tabindex="12" class="validate[required,custom[email]]" required />
	</div>
	</div>
<br><br>
<div class="form_info submit_wrap"><button type="submit" class="cmsms_button" id="contact_form_1_formsend" tabindex="14">Login</button></div>
<br>

...
<div id="page-content">
	...
	<input type="text" name="con_name" id="con_name" size="35"  >
	</div>
	</div>
	<br><br>
<div class="form_info cmsms_input">
	<label for="contact_email_1">Email<span class="color_2"> *</span></label>
	<div class="form_field_wrap">
	<input type="text" name="contact_email" id="contact_email" size="35"  required />
	</div>
	</div>
<br><br>
<div class="form_info cmsms_input">
	<label for="contact_email_1">Password<span class="color_2"> *</span></label>
	<div class="form_field_wrap">
...
<div class="form_info cmsms_input">
	...
	<div class="form_field_wrap">
	<input type="text" name="contact_no" id="contact_no" size="35"  required />
	</div>
	</div>
	<br><br>
	<div class="form_info cmsms_input">
	<label for="contact_email_1">Type of user<span class="color_2"> *</span></label>
	<div class="form_field_wrap">
	...
	<br><br>
<div class="form_info submit_wrap"><button type="submit" class="cmsms_button" id="contact_form_1_formsend" tabindex="14">Sign Up</button></div>
<br>
